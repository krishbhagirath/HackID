    ...
    <aside className="w-full lg:w-80 flex-shrink-0">
      <div className="sticky top-32 space-y-6">
        ...
        <div className="brutal-border bg-zinc-900 p-6 brutal-shadow">
          <label className="block text-xs font-bold uppercase mb-2">Target URL</label>
          <div className="relative">
            ...
            />
            {/* <span className="material-icons absolute right-3 top-3 opacity-50">link</span> */}
          </div>
          <button 
            onClick={onScan}
            disabled={isScanning}
          ...
          >
            {isScanning ? 'Scanning...' : 'Re-Scan Submissions'}
          </button>
        </div>
        ...
        <div className="brutal-border bg-zinc-900 p-6 brutal-shadow">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-xs font-bold uppercase mb-2">Min. Similarity Score: {minScore}%</label>
              <input 
        ...
        <div className="brutal-border bg-zinc-800 p-6">
          <div className="grid grid-cols-2 gap-4 text-white dark:text-white">
            <div>
              ...
              <div className="text-[10px] uppercase font-bold">Total Scanned</div>
            </div>
            <div>
